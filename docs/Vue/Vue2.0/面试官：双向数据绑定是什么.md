...
当用户填写表单时，`View`的状态就被更新了，如果此时可以自动更新`Model`的状态，那就相当于我们把`Model`和`View`做
...
![image](https://github.com/linwu-hi/code-interview/assets/137023716/64ad02ee-ec79-41d7-87c1-e8a846cdfa9d)
...
![image](https://github.com/linwu-hi/code-interview/assets/137023716/68809235-ddb9-4ca2-824b-f4e3bcae5d8b)
...
![image](https://github.com/linwu-hi/code-interview/assets/137023716/cce910d9-8010-436b-8acd-b398b5cd8b9a)
