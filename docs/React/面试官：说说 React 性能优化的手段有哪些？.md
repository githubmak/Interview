...
![image](https://github.com/linwu-hi/code-interview/assets/137023716/bda1a5e1-beb8-4b84-9fba-1a078c0f3183)

理想状态只调用该路径下的组件`render`：

![image](https://github.com/linwu-hi/code-interview/assets/137023716/a88fac0d-7401-441b-abb0-34b572fff7a2)

但是`react`的默认做法是调用所有组件的`render`，再对生成的虚拟`DOM`进行对比（黄色部分），如不变则不进行更新

![image](https://github.com/linwu-hi/code-interview/assets/137023716/c9977d17-1b45-4230-8170-48961aae3e0f)
